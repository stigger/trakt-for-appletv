...
# source: TextEditingAttributes.proto
...
from . import TextInputTraits_pb2 as TextInputTraits__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='TextEditingAttributes.proto',
  package='',
  syntax='proto2',
  serialized_pb=_b('\n\x1bTextEditingAttributes.proto\x1a\x15TextInputTraits.proto\"]\n\x15TextEditingAttributes\x12\r\n\x05title\x18\x01 \x01(\t\x12\x0e\n\x06prompt\x18\x02 \x01(\t\x12%\n\x0binputTraits\x18\x03 \x01(\x0b\x32\x10.TextInputTraits')
  ,
  dependencies=[TextInputTraits__pb2.DESCRIPTOR,])
...
_TEXTEDITINGATTRIBUTES.fields_by_name['inputTraits'].message_type = TextInputTraits__pb2._TEXTINPUTTRAITS
...
TextEditingAttributes = _reflection.GeneratedProtocolMessageType('TextEditingAttributes', (_message.Message,), dict(
  ...
  __module__ = 'TextEditingAttributes_pb2'
