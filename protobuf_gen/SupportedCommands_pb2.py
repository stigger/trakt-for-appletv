...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='SupportedCommands.proto',
  package='',
  syntax='proto2',
  serialized_pb=_b('\n\x17SupportedCommands.proto\x1a\x11\x43ommandInfo.proto\"<\n\x11SupportedCommands\x12\'\n\x11supportedCommands\x18\x01 \x03(\x0b\x32\x0c.CommandInfo')
  ,
  dependencies=[CommandInfo__pb2.DESCRIPTOR,])
...
_SUPPORTEDCOMMANDS.fields_by_name['supportedCommands'].message_type = CommandInfo__pb2._COMMANDINFO
...
SupportedCommands = _reflection.GeneratedProtocolMessageType('SupportedCommands', (_message.Message,), dict(
  ...
  __module__ = 'SupportedCommands_pb2'
