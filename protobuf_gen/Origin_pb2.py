...
from . import DeviceInfoMessage_pb2 as DeviceInfoMessage__pb2
...
_ORIGIN.fields_by_name['deviceInfo'].message_type = DeviceInfoMessage__pb2._DEVICEINFOMESSAGE
