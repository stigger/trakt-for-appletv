...
from . import TextEditingAttributes_pb2 as TextEditingAttributes__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='KeyboardMessage.proto',
  package='',
  syntax='proto2',
  serialized_pb=_b('\n\x15KeyboardMessage.proto\x1a\x15ProtocolMessage.proto\x1a\x1bTextEditingAttributes.proto\"L\n\x0fKeyboardMessage\x12\r\n\x05state\x18\x01 \x01(\x05\x12*\n\nattributes\x18\x03 \x01(\x0b\x32\x16.TextEditingAttributes:;\n\x0fkeyboardMessage\x12\x10.ProtocolMessage\x18\x1c \x01(\x0b\x32\x10.KeyboardMessage')
  ,
  dependencies=[ProtocolMessage__pb2.DESCRIPTOR,TextEditingAttributes__pb2.DESCRIPTOR,])
...
_KEYBOARDMESSAGE.fields_by_name['attributes'].message_type = TextEditingAttributes__pb2._TEXTEDITINGATTRIBUTES
...
KeyboardMessage = _reflection.GeneratedProtocolMessageType('KeyboardMessage', (_message.Message,), dict(
  ...
  __module__ = 'KeyboardMessage_pb2'
...
ProtocolMessage__pb2.ProtocolMessage.RegisterExtension(keyboardMessage)
