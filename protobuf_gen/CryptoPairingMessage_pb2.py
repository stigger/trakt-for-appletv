...
CryptoPairingMessage = _reflection.GeneratedProtocolMessageType('CryptoPairingMessage', (_message.Message,), dict(
  ...
  __module__ = 'CryptoPairingMessage_pb2'
...
ProtocolMessage__pb2.ProtocolMessage.RegisterExtension(cryptoPairingMessage)
