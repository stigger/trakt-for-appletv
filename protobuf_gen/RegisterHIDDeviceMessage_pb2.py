...
from . import VirtualTouchDeviceDescriptor_pb2 as VirtualTouchDeviceDescriptor__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='RegisterHIDDeviceMessage.proto',
  package='',
  syntax='proto2',
  serialized_pb=_b('\n\x1eRegisterHIDDeviceMessage.proto\x1a\x15ProtocolMessage.proto\x1a\"VirtualTouchDeviceDescriptor.proto\"S\n\x18RegisterHIDDeviceMessage\x12\x37\n\x10\x64\x65viceDescriptor\x18\x01 \x01(\x0b\x32\x1d.VirtualTouchDeviceDescriptor:M\n\x18registerHIDDeviceMessage\x12\x10.ProtocolMessage\x18\x0b \x01(\x0b\x32\x19.RegisterHIDDeviceMessage')
  ,
  dependencies=[ProtocolMessage__pb2.DESCRIPTOR,VirtualTouchDeviceDescriptor__pb2.DESCRIPTOR,])
...
_REGISTERHIDDEVICEMESSAGE.fields_by_name['deviceDescriptor'].message_type = VirtualTouchDeviceDescriptor__pb2._VIRTUALTOUCHDEVICEDESCRIPTOR
...
RegisterHIDDeviceMessage = _reflection.GeneratedProtocolMessageType('RegisterHIDDeviceMessage', (_message.Message,), dict(
  ...
  __module__ = 'RegisterHIDDeviceMessage_pb2'
...
ProtocolMessage__pb2.ProtocolMessage.RegisterExtension(registerHIDDeviceMessage)
