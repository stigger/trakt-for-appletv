...
ClientUpdatesConfigMessage = _reflection.GeneratedProtocolMessageType('ClientUpdatesConfigMessage', (_message.Message,), dict(
  ...
  __module__ = 'ClientUpdatesConfigMessage_pb2'
...
ProtocolMessage__pb2.ProtocolMessage.RegisterExtension(clientUpdatesConfigMessage)
