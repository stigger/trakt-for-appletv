...
_TRANSACTIONPACKET.fields_by_name['key'].message_type = TransactionKey__pb2._TRANSACTIONKEY
...
TransactionPacket = _reflection.GeneratedProtocolMessageType('TransactionPacket', (_message.Message,), dict(
  ...
  __module__ = 'TransactionPacket_pb2'
