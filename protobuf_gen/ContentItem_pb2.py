...
_CONTENTITEM.fields_by_name['metadata'].message_type = ContentItemMetadata__pb2._CONTENTITEMMETADATA
_CONTENTITEM.fields_by_name['availableLanguageOptions'].message_type = LanguageOption__pb2._LANGUAGEOPTION
_CONTENTITEM.fields_by_name['currentLanguageOptions'].message_type = LanguageOption__pb2._LANGUAGEOPTION
