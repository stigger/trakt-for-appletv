...
_REMOVEPLAYERMESSAGE.fields_by_name['playerPath'].message_type = PlayerPath__pb2._PLAYERPATH
...
RemovePlayerMessage = _reflection.GeneratedProtocolMessageType('RemovePlayerMessage', (_message.Message,), dict(
  DESCRIPTOR = _REMOVEPLAYERMESSAGE,
  __module__ = 'RemovePlayerMessage_pb2'
...
ProtocolMessage__pb2.ProtocolMessage.RegisterExtension(removePlayerMessage)
